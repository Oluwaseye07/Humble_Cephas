...
Before performing analysis, the dataset was cleaned and structured to ensure accuracy and consistency in reporting.
...
To ensure accurate revenue analysis, a new column titled \*\*Revenue\*\* was created. This column retained only positive billing values, while negative values were excluded, as revenue represents income generated from healthcare services and including negative values would distort financial analysis.
